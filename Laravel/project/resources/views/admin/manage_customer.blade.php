				...
				<div class="card-body">
				  ...
				  <div class="table-responsive mt-4">
					<table class="table mb-0 text-nowrap varient-table align-middle fs-3">
					  ...
					  ?>
						<tr>
						   <td class="px-0"><img src="../website/img/customer/<?php echo $value->image?>" width="50px" height="50px"/></td>
						  ...
						  <td class="px-0 text-center">
							...
							<a href="admin_status?status_customer=<?php echo $value->uid?>" class="btn btn-success">
