		...
		<div class="flexslider flexslider-banner">
		  <ul class="slides">
		    <li>
		      ...
		      <img src="{{url('website/img/banner-2.jpg')}}" />
		    </li>
		    <li>
			    <div class="tm-banner-inner">
		      ...
		      <img src="{{url('website/img/banner-3.jpg')}}" />
		    </li>
		    <li>
			    <div class="tm-banner-inner">
		      ...
		      <img src="{{url('website/img/banner-1.jpg')}}" />
		    </li>
		  </ul>
		</div>			
	</section>
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
				<div class="tm-home-box-1 tm-home-box-1-2 tm-home-box-1-center">
					<img src="{{url('website/img/index-01.jpg')}}" alt="image" class="img-responsive">
					<a href="#">
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
				<div class="tm-home-box-1 tm-home-box-1-2 tm-home-box-1-right">
					<img src="{{url('website/img/index-02.jpg')}}" alt="image" class="img-responsive">
					<a href="#">
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="tm-tours-box-1">
						<img src="{{url('website/img/tours-03.jpg')}}" alt="image" class="img-responsive">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="tm-tours-box-1">
						<img src="{{url('website/img/tours-04.jpg')}}" alt="image" class="img-responsive">
						<div class="tm-tours-box-1-info">
							<div class="tm-tours-box-1-info-left">
								<p class="text-uppercase margin-bottom-20">Proin Gravida Nibhvel Lorem Quis Bind</p>	
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="tm-tours-box-1">
						<img src="{{url('website/img/tours-05.jpg')}}" alt="image" class="img-responsive">
						<div class="tm-tours-box-1-info">
							<div class="tm-tours-box-1-info-left">
								<p class="text-uppercase margin-bottom-20">Proin Gravida Nibhvel Lorem Quis Bind</p>	
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="tm-tours-box-1">
						<img src="{{url('website/img/tours-06.jpg')}}" alt="image" class="img-responsive">
						<div class="tm-tours-box-1-info">
							<div class="tm-tours-box-1-info-left">
								<p class="text-uppercase margin-bottom-20">Proin Gravida Nibhvel Lorem Quis Bind</p>	
			...
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="tm-tours-box-2">						
						<img src="{{url('website/img/index-03.jpg')}}" alt="image" class="img-responsive">
						<div class="tm-tours-box-2-info">
							<h3 class="margin-bottom-15">Proin Gravida Nibhvel Lorem Quis Bind</h3>
							<img src="{{url('website/img/rating.png')}}" alt="image" class="margin-bottom-5">
							<p>28 March 2084</p>	
						</div>						
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="tm-tours-box-2">						
						<img src="{{url('website/img/index-04.jpg')}}" alt="image" class="img-responsive">
						<div class="tm-tours-box-2-info">
							<h3 class="margin-bottom-15">Proin Gravida Nibhvel Lorem Quis Bind</h3>
							<img src="{{url('website/img/rating.png')}}" alt="image" class="margin-bottom-5">
							<p>26 March 2084</p>	
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="tm-tours-box-2">						
						<img src="{{url('website/img/index-05.jpg')}}" alt="image" class="img-responsive">
						<div class="tm-tours-box-2-info">
							<h3 class="margin-bottom-15">Proin Gravida Nibhvel Lorem Quis Bind</h3>
							<img src="{{url('website/img/rating.png')}}" alt="image" class="margin-bottom-5">
							<p>24 March 2084</p>	
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="tm-tours-box-2">						
						<img src="{{url('website/img/index-06.jpg')}}" alt="image" class="img-responsive">
						<div class="tm-tours-box-2-info">
							<h3 class="margin-bottom-15">Proin Gravida Nibhvel Lorem Quis Bind</h3>
							<img src="{{url('website/img/rating.png')}}" alt="image" class="margin-bottom-5">
							<p>22 March 2084</p>	
